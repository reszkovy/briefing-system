...
IMGS = {
    ...
    "guide": "art-guide.jpg",
    "guide/instruction": "art-instruction.jpg",
    "guide/operational-alchemy": "art-alchemy-ops.jpg",
    ...
    "figures/balinas": "art-vault.jpg",
    "figures/grs-mead": "art-mead-desk.jpg",
    "ideas/hermeticism-and-its-neighbours": "art-lamps.jpg",
...
<script src="/assets/site.js?v=33" defer></script>
...
<link rel="stylesheet" href="/assets/site.css?v=33"></head><body>
{HEADER}
...
</div></article></main>{FOOTER}<script src="/assets/site.js?v=33" defer></script>
<script defer src="/_vercel/insights/script.js"></script>
<script async src="https://www.googletagmanager.com/gtag/js?id=G-P0HHD2HX20"></script>
<script>
window.dataLayer=window.dataLayer||[];function gtag(){{dataLayer.push(arguments);}}
