  ...
  const templates = await Promise.all([
    ...
    prisma.requestTemplate.create({
      data: {
        ...
        code: 'SOCIAL_POST',
        description: 'Pojedynczy post lub karuzela na social media klubu. Obejmuje Facebook i Instagram.',
        defaultSLADays: 3,
        requiredFields: {
          type: 'object',
          ...
          properties: {
            channels: {
              ...
              description: 'Wybierz gdzie ma być opublikowany post',
              items: {
                type: 'string',
                enum: ['facebook', 'instagram_feed', 'instagram_stories', 'instagram_reels'],
                enumNames: ['Facebook', 'Instagram (feed)', 'Instagram Stories', 'Instagram Reels'],
              },
              minItems: 1,
            },
            formats: {
              ...
              items: {
                ...
                enumNames: ['Pojedyncza grafika', 'Karuzela (do 10 slajdów)', 'Video', 'Zestaw stories'],
              },
              minItems: 1,
            },
            mainMessage: {
            ...
            hashtags: {
              ...
              description: 'Opcjonalne - jeśli masz preferencje',
            },
            callToAction: {
              type: 'string',
              title: 'Call to Action',
              description: 'Co ma zrobić odbiorca po zobaczeniu posta?',
              enum: ['Zapisz się', 'Sprawdź ofertę', 'Zadzwoń', 'Przyjdź do klubu', 'Kup teraz', 'Dowiedz się więcej', 'Inne'],
            },
            inspirationLinks: {
              type: 'string',
              title: 'Linki do inspiracji',
              description: 'Posty konkurencji lub inne materiały które Ci się podobają',
            },
          },
        },
      },
    ...
    prisma.requestTemplate.create({
      data: {
        ...
        requiredFields: {
          type: 'object',
          required: ['infoType', 'mainMessage', 'displayLocations'],
          properties: {
            infoType: {
              type: 'string',
            ...
            displayLocations: {
              type: 'array',
              title: 'Gdzie będzie wyświetlane',
              items: {
                type: 'string',
                enum: ['tv_recepcja', 'tv_silownia', 'facebook', 'instagram_stories', 'druk_A4'],
                enumNames: ['TV na recepcji', 'TV na siłowni', 'Facebook', 'Instagram Stories', 'Wydruk A4'],
              },
              minItems: 1,
            },
          },
    ...
    prisma.requestTemplate.create({
      data: {
        ...
        requiredFields: {
          type: 'object',
          required: ['campaignName', 'campaignType', 'channels', 'mainMessage'],
          properties: {
            campaignName: {
              type: 'string',
            ...
            channels: {
              type: 'array',
              title: 'Kanały kampanii',
              items: {
                type: 'string',
                enum: ['facebook', 'instagram', 'google_ads', 'outdoor', 'druk', 'mailing', 'www'],
              },
              minItems: 1,
            },
            mainMessage: {
            ...
            targetAudience: {
              ...
              description: 'Do kogo kierowana jest kampania?',
            },
            budget: {
              type: 'string',
              title: 'Planowany budżet mediowy',
              enum: ['do_500', '500_1000', '1000_2500', '2500_5000', 'powyzej_5000', 'brak_budzetu'],
              enumNames: ['Do 500 PLN', '500-1000 PLN', '1000-2500 PLN', '2500-5000 PLN', 'Powyżej 5000 PLN', 'Brak (tylko organiczne)'],
            },
          },
        },
      },
